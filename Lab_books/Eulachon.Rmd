...
```{r}
Samples_Eulachon_with_Thermocline <- read_csv(here("Data", "Samples_Eulachon_with_Thermocline.csv"))
...
Step2 %>% 
  ...
  facet_wrap(~fct_relevel(Transect,'77','73','71','69'), ncol = 1, scale = "free_x") +
  theme_minimal() +
