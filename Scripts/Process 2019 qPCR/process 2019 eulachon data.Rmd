...
## Save
```{r}
write_rds(dat.stand,here('Data','eulachon qPCR 2019 standards cleaned 11_20_2023.rds'))
```
...
```{r}
dat.samp <- dat.all %>% 
  dplyr::select(qPCR,well,sample,IPC_Ct,inhibition_rate,dilution,task,Zymo,contains(SP)) %>%
