          ...
          index_args = NULL, experimental = NULL) 
{
  ...
  tmb_params <- list(ln_H_input = matrix(0, nrow = 2L, ncol = n_m), 
                     ...
                     b_j2 = if (delta) rep(0,ncol(X_ij[[2]])) else numeric(0), 
                     ...
                     thetaf = 0, 
                     logit_p_mix = 0, 
                     log_ratio_mix = 0, ln_phi = rep(0, n_m), 
                     ln_tau_V = matrix(0, ncol(X_rw_ik), n_m), 
                     rho_time_unscaled = matrix(0, ncol(X_rw_ik), n_m), ar1_phi = rep(0, n_m), 
                     ln_tau_G = matrix(0, ncol(RE_indexes), n_m), RE = matrix(0, sum(nobs_RE), 
